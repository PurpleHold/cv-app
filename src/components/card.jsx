            ...
            <div className="top">
                ...
                <div className="position">
                    ...
                    <div className="pos-container">
                        <button aria-label="up" className="pos-up" onClick={() => onPosChange(type, -1)}>
                            <i className="iconoir-page-up"></i>
                        </button>
                        <button aria-label="left" className="pos-left" onClick={() => onPosChange()}>
                            <i className="iconoir-page-left"></i>
                        </button>
                        <button aria-label="right" className="pos-right" onClick={() => onPosChange()}>
                            <i className="iconoir-page-right"></i>
                        </button>
                        <button aria-label="down" className="pos-down" onClick={() => onPosChange(type, 1)}>
